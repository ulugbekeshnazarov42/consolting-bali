...
import { MessageCircle, Compass, FileText, Plane } from "lucide-react";
import { Badge } from "@/components/ui/badge";

const steps = [
  {
    icon: MessageCircle,
    title: "Tanishuv va suhbat",
    desc: "Maqsadlaringiz, yoshingiz va imkoniyatlaringiz haqida ochiq suhbat. Birinchi uchrashuv — bepul.",
    duration: "30–45 daqiqa",
  },
  {
    icon: Compass,
    title: "Yo'nalish tanlash",
    desc: "Singapur, Bali yoki Qatar/Dubay — sizga eng mos yo'nalishni birga tanlaymiz va reja tuzamiz.",
    duration: "1–2 hafta",
  },
  {
    icon: FileText,
    title: "Hujjatlar tayyorlash",
    desc: "Ariza, motivatsion xat, tarjimalar va viza hujjatlarini bosqichma-bosqich to'ldiramiz.",
    duration: "2–6 hafta",
  },
  {
    icon: Plane,
    title: "Ketish va moslashish",
    desc: "Jo'nash oldidan brifing, borganidan keyin ham savollaringizga javob — yolg'iz qolmaysiz.",
    duration: "Davomiy qo'llab-quvvatlash",
  },
];
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <h2 className="text-balance text-5xl font-extrabold leading-[1.05] tracking-tight md:text-6xl md:leading-[1.04] lg:text-6xl lg:leading-[1.05] xl:text-7xl xl:leading-[1.03]">
            <span className="text-gradient-orange">4 bosqich</span> —
            tanishuvdan ketishgacha
          </h2>
          <p className="mt-5 text-lg text-muted-foreground">
            Har bir bosqichda sizga nima kerak va nima bo'lishini oldindan
            tushuntiramiz. Yo'lda yolg'iz qolmaysiz.
          </p>
        </motion.div>
