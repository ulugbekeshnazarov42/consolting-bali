...
const SECTION_HEADING_SCALE =
  "font-heading text-balance font-extrabold capitalize tracking-tight sm:tracking-[-0.02em] " +
...
const SECTION_HEADING_SCALE_NEWS =
  "font-heading text-balance font-extrabold capitalize tracking-tight sm:tracking-[-0.025em] " +
